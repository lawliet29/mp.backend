...
{
    public class OrganicFertilizerController : ApiController
    {
        private readonly IOrganicFertilizerService _service;
        public OrganicFertilizerController(IOrganicFertilizerService service)
        {
            _service = service;
        }
